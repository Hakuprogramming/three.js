...
const donutParticlesGeomoety = new THREE.TorusGeometry(2.8, 0.7, 16, 100)
...
const dountParticles = new THREE.Points(
  donutParticlesGeomoety,
...
scene.add(dountParticles, particles)
